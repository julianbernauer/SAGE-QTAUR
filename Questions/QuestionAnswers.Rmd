...
CRAN ("The Comprehensive R Archive Network") hosts R packages, you can check the CRAN site of a package for more information on the package, including information on how to cite it. 
...
A document-feature matrix is the numerical representation of a text, storing the number of occurrences of words or other tokens cross texts. As especially for shorter texts, many words will not appear at all, entries with '0' can be plenty. The more zeros there are, the more sparse the 

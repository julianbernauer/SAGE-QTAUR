...
-   a way of sharing data from one program to another

-   for us: automated way of retrieving the data we need

-   to find a song on genius.com you would use the search function:

    ![](genius.JPG)

-   instead we use the R package geniusr, validate our token and use a line of code:
...
-   = to legally access the content of web databases in an automated fashion using programming code [@munzert2015]

-   only if there is no API available

-   follow laws and webpage rules
